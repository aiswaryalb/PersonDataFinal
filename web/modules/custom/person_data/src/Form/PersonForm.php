  ...
  public function save(array $form, FormStateInterface $form_state): int {
    ...
    switch ($result) {
      case SAVED_NEW:
        ...
        $this->logger('person_data')->notice('New person %label has been created.', $logger_args);
        break;

      case SAVED_UPDATED:
        $this->messenger()->addStatus($this->t('The person %label has been updated.', $message_args));
        $this->logger('person_data')->notice('The person %label has been updated.', $logger_args);
        break;
